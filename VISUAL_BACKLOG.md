...
### ✅ DONE #1 — Elevate all four card panel titles to DS.Typography.titleM
...
### ✅ DONE #2 — Switch Browse modal background to DS.Palette.modalBG
...
### ✅ DONE #3 — Tokenize Browse row hover background (surfaceAlt + DS.Radius.small)
**File:** Salehman AI/Views/BrowseMarketsView.swift
...
### ✅ DONE #4 — Premium gradient divider in RuneScape fastest-flips strip
...
### ✅ DONE #5 — Upgrade fastest-flips strip stroke to a warningSoft bezel gradient
**File:** Salehman AI/Views/RuneScapeMarketView.swift
...
### ✅ DONE #6 — Standardize row hover opacity to a single token across all interactive rows
**File:** Salehman AI/Views/MarketsView.swift
...
### ✅ DONE #7 — Promote RuneScape sub-strip title to bolder white type
**File:** Salehman AI/Views/RuneScapeMarketView.swift
...
### ✅ DONE #8 — Align RuneScape status-banner stroke stops with MarketsView liveBanner
**File:** Salehman AI/Views/RuneScapeMarketView.swift
...
### ✅ DONE #9 — Use DS.Space.sm for fastest-flips strip vertical spacing
**File:** Salehman AI/Views/RuneScapeMarketView.swift
...
### ✅ DONE #10 — Tokenize Browse + RuneScape search-field backgrounds to surfaceAlt family
**File:** Salehman AI/Views/BrowseMarketsView.swift
...
### ✅ DONE #11 — Add a strokeBorder to the RuneScape P2P member capsule
**File:** Salehman AI/Views/RuneScapeMarketView.swift
...
### ✅ DONE #12 — Give Browse modal more breathing room (DS.Space.lg padding)
**File:** Salehman AI/Views/BrowseMarketsView.swift
...
### ✅ DONE #13 — Bump Browse title to titleM and subtitle to readable body
**File:** Salehman AI/Views/BrowseMarketsView.swift
...
### ✅ DONE #14 — Lighten sub-section group subtitles for white-on-dark contrast
**File:** Salehman AI/Views/MarketsView.swift
...
### ✅ DONE #15 — Tint ProgressView spinners with the brand accent
**File:** Salehman AI/Views/MarketsView.swift
...
### ✅ DONE #16 — Tokenize idea-detail-sheet divider radius to DS.Radius.small
**File:** Salehman AI/Views/MarketsView.swift
...
### ✅ DONE #17 — Promote priceColumn label color to DS.Palette.textSecondary
**File:** Salehman AI/Views/RuneScapeMarketView.swift
...
**2026-06-28: all 17 done** (#1 was already shipped in a prior pass; #2-17 done this batch — see DEVELOPMENT_LOG.md).
