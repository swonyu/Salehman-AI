...
## Backlog
### ✅ DONE #1 — Refresh button hit target below 44pt
...
### ✅ DONE #2 — R-multiple distribution histogram bars are color-only / invisible to VoiceOver
...
### ✅ DONE #3 — RuneScape & Browse search fields expose only placeholder, no accessibilityLabel
...
### ✅ DONE #4 — Heatmap & correlation grids lack a container announcement
...
### ✅ DONE #5 — Detail-sheet & compounding sparklines hidden from VoiceOver with no text summary
...
### ✅ DONE #6 — Conviction meter gauge has no accessibilityValue
...
### ✅ DONE #10 — Decorative magnifying-glass icons not hidden from VoiceOver
