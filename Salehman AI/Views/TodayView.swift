    ...
    private var statCards: some View {
        LazyVGrid(columns: [GridItem(.adaptive(minimum: 170), spacing: DS.Space.md)], spacing: DS.Space.md) {
            ...
            if !AppTab.hidden.contains(.markets) {
                ...
                if let best = StockSageExpectedValue.bestOpportunity(stockSage.ideas, regime: stockSage.regime, earnings: stockSage.earnings, liquidity: stockSage.liquidity, calibration: stockSage.convictionCalibration) {
